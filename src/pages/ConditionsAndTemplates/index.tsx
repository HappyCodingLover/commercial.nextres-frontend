...
const leftMenuItems: menuType = {
  ...
  conditionTemplates: 'Condition Templates',
  tasks: 'Tasks',
}

export function ConditionsAndTemplates() {
  useTitle(`Conditions and Templates - ${process.env.REACT_APP_COMPANY}`)
  ...
  const setMenu = (menuItem: string) => {
    ...
    navigate(`/condition_template/${menuItem}`)
  }
